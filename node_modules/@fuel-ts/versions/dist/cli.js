...
__export(cli_exports, {
  ...
  getBuiltinVersions: () => getBuiltinVersions,
...
var colorizeUserVersion = (params) => {
  ...
  if (isGt) {
    return import_chalk.default.cyan(version);
  }
  if (isOk) {
    return import_chalk.default.green(version);
  }
  return import_chalk.default.red(version);
};
...
You have all the right versions! \u26A1`);
 ...
 - You're using outdated versions`);
  ...
  if (exitCode === 1) {
    error(`  ${import_chalk2.default.green(fuelUpLink)}`);
  }
